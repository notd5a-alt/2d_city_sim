...
Tile::Tile(int id, TileCoords coord, TerrainType terrain, TileResources resources) {
  this->id = id;
...
TileResources Tile::getResources() const {
...
int Tile::getResourceStone() const {
  return this->resources.stone;
}

void Tile::setResourceStone(int stone) {
  this->resources.stone = stone;
}

int Tile::getResourceWood() const {
  return this->resources.wood;
}

void Tile::setResourceWood(int wood) {
  this->resources.wood = wood;
}

int Tile::getResourceOil() const {
  return this->resources.oil;
}

void Tile::setResourceOil(int oil) {
  this->resources.oil = oil;
}

int Tile::getResourceWater() const {
  return this->resources.water;
}

void Tile::setResourceWater(int water) {
...
TileCoords Tile::getCoords() const {
  return this->coord;
}
...
void Tile::placeBuilding(Building building) {
  this->building = building;
}

void Tile::removeBuilding(Building building) {
  this->building = {};
}
...
std::vector<Person> Tile::getPersons() const {
  return this->persons;
}

void Tile::setPersons(std::vector<Person> persons) {
  this->persons = persons;
}

void Tile::addPerson(Person person) {
